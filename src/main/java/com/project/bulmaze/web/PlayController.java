...
public class PlayController {
    ...
    public PlayController(QuestionService questionService, AnswerService answerService, UserService userService, OptionsService optionsService, ClueService clueService) {
    ...
    public String postQuestion(@Valid @ModelAttribute(name = "answerDTO") AnswerDTO answerDTO,
        ...
        AnswerDTO answer = this.answerService.getAnswer(user.getUserProgress());

        if (this.answerService.compareAnswers(answer.getDescription(), answerDTO.getDescription())) {
            this.userService.addCorrectAnswer(user, answer);
        }
